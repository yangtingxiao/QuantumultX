/*
天天挖矿
更新时间：2020-10-22 18:06
脚本说明：支付宝天天挖矿小程序 beta

圈X:
10 0 * * * https://raw.githubusercontent.com/yangtingxiao/QuantumultX/master/scripts/ttwk/ttwk.js, tag=天天挖矿, img-url=https://raw.githubusercontent.com/yangtingxiao/QuantumultX/master/image/ttwk.png, enabled=true
...
function showSignInfo(timeout = 0) {
  return new Promise((resolve) => {
    setTimeout( ()=>{
      let url = {
        url : $.getdata('ttwksignurl').replace('createSign','showSignInfo'),
        headers : JSON.parse($.getdata('ttwksignheader')),
        body : {}
      }
...
function msgShow() {
  ...
  } else if ($.result.code === "200" && $.result.data.success === "false") {
    message += '挖矿失败：重复挖矿\n'
  }
